...
export const VIDEO_REVIEW_DIMENSIONS = [
  {
    name: "接客時の表情・姿勢・態度",
    criterion: "接客ロールプレイ中に、笑顔を含む表情、相手の話を聞く反応、落ち着いた姿勢から、安心感のある応対ができているか。顔立ち・容姿・服装・背景・障害や健康状態の推測は評価しない。",
    weight: 2,
  },
  {
    name: "接客ロールプレイの進行",
...
# 安全と公平性
- 年齢、生年月日、性別、婚姻、妊娠、家族構成、家族関係、出生地、本籍、住居・資産、宗教、思想信条、支持政党、医療・病歴・障害など、職務に不要な個人情報は質問しない。
- 応募者が上記を自発的に話した場合、深掘りせず、採用評価に使わない。
- 自動音声システムと回答本文の自動評価では、顔、容姿、表情、声質、話す速さ、訛り、感情推定を評価しない。
- 録画映像は、接客ロールプレイ中の笑顔を含む表情、話を聞く反応、姿勢、応対態度、職務上の説明、安全配慮を、採用担当者が共通基準で確認するために使う。生まれつきの顔立ち・容姿、服装、背景、カメラ品質、障害や健康状態の推測は評価に使わない。表情から性格や内心の感情を自動推定しない。
