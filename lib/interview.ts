...
export const LIGHT_OPENING_QUESTION =
  "まず、今のお仕事や学校について、簡単に教えてください。";
...
/**
 * Job-related questions for the recorded contingency path. Candidates answer
 * aloud and recruiters review the recording; placeholder transcript entries are
 * never used to generate automatic scores.
 */
export const RECORDED_FALLBACK_QUESTIONS = [
  LIGHT_OPENING_QUESTION,
  "直近の勤務先を選んだ理由と、退職または転職を考えた理由、状況を良くするために試したこと、そこから学んだことを教えてください。",
  "勤務を開始できる時期を教えてください。",
  "仕事で大切にしたい価値観と、1年から3年後に実現したい働き方を教えてください。",
  "仕事選びで大切にしている条件を優先順に三つ、TOKYO DOGSに魅力を感じた点、現在の志望度を5段階で表した数字とその理由を教えてください。",
  "犬に関わる仕事やペット業界の中でTOKYO DOGSを選んだ理由と、清掃、生体管理、記録、報告、飼い主対応を含む仕事内容への理解を教えてください。",
  "相手の期待をくみ取り、対応を工夫した具体的な経験を、状況、ご自身の行動、結果の順で教えてください。",
  "飼い主様から『犬が言うことを聞かず困っています』と相談された想定で、実際の接客のつもりで1分から2分程度お話しください。",
  "指摘を受けた時やミスが起きた時に、報告、対応、行動の修正、再発防止を行った具体例を教えてください。",
  "未経験のことを学び、一定期間続けた経験と、途中でつまずいた時にどう対応したかを教えてください。",
  "犬が興奮した時や判断に迷った時、犬と人の安全のためにどのように行動し、誰へ相談または報告しますか。",
  "希望店舗以外への配属や他店舗のヘルプが発生する可能性があります。この点を理解したうえで、土日勤務、通勤、対応できる店舗、頻度、条件を教えてください。",
  "普通自動車免許、業務での運転、送迎や当直への対応可能範囲と、犬に関わった経験を教えてください。実際の必要条件は採用担当者が確認します。",
  "仕事内容や提示条件について不安な点、長期的な就業意向、対面面接または職場体験への参加可否を教えてください。",
...
- 冒頭案内の直後は、必ず「${LIGHT_OPENING_QUESTION}」だけを質問する。自己紹介や詳しい経歴を一度に求めず、回答を受けてから職歴、退職理由、志望理由へ自然に深める。最初から詰問のような「なぜ」を重ねない。
...
- 通常の今後の流れは「オンライン一次面接の記録を権限を付与された採用担当者が確認し、通過の場合は対面面接または職場体験で条件をすり合わせる」と案内する。結果連絡は通常数日〜1週間、長い場合は10日程度を目安とし、確約はしない。
- 終了時は、このオンライン一次面接の回答内容が採用選考の重要な判断資料として選考結果に反映され、権限を付与された採用担当者が回答内容を確認して判断することを伝える。評価内容は応募者画面には表示されない。
