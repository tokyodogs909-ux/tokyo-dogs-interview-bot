...
function installInterviewBindings(bindings: Env) {
  (globalThis as typeof globalThis & {
    ...
    INTERVIEW_MANUAL_REPAIR_TOKEN: bindings.INTERVIEW_MANUAL_REPAIR_TOKEN,
    INTERVIEW_MANUAL_REPAIR_SESSION_IDS: bindings.INTERVIEW_MANUAL_REPAIR_SESSION_IDS,
  };
}
